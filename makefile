...
-L/usr/local/lib\
-lopencv_calib3d -lopencv_core -lopencv_dnn -lopencv_features2d -lopencv_flann -lopencv_highgui -lopencv_imgcodecs -lopencv_imgproc -lopencv_ml -lopencv_objdetect -lopencv_objdetect -lopencv_shape -lopencv_stitching -lopencv_superres -lopencv_video -lopencv_videoio -lopencv_videostab
else
LDFLAGS                 :=-lgxiapi -ldximageproc -lpthread \
...
$(NAME)			: $(NAME).o
	$(LD) -o $@ $^ $(CPPFLAGS) $(LDFLAGS) serialSend.o
